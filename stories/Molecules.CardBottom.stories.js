    ...
    docs: {
      description: {
        component:
          ...
          "Incluye las variantes vistas en Figma: **Default**, **OKY Vales**, **Code + Firma**, **With Bar Code**, **With QR Code**, **Code + BAR CODE + PIN**, **BAR CODE + Code + PIN**, **Oh Gif Card**, **Gift Card** y **Telco**. " +

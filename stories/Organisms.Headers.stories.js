...
const loginBitmap = () => `
  <div class="header-icon header-icon-bitmap header-icon-bitmap-login-wrap" aria-hidden="true">
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Headers del app OKY. " +
          "**WO8oM, ArMsV y la nueva variante Both Ind** usan bitmaps desde `/images` para coincidir con Figma. " +
          "El punto rojo del estado con indicador se construye con HTML/CSS sobre el bitmap. " +
          "`ZPc9u` conserva el icono de usuario hasta que exista `Log-In-Icon.png`. " +
...
export const AllHeaders = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: "WO8oM, ArMsV y la nueva variante Both Ind usan bitmaps del folder `images`. Los dots rojos se construyen con HTML/CSS sobre los bitmaps. ZPc9u conserva el usuario Font Awesome hasta que exista el bitmap de login.",
      },
    },
  },
  render: () => `

/**
 * Headers — DS-MARS v2
 * Icon rule: fa-light fa-wallet for wallet icon · fa-light for remaining header icons · fa-solid only for fa-circle-user (not-logged)
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Headers del app OKY. " +
          "**Regla de íconos:** `fa-light fa-wallet` para wallet · `fa-light` para el resto de íconos de header · " +
...
export const AllHeaders = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: "Referencia visual de las variantes de header. Wallet usa `fa-light fa-wallet` + `icon-medium`; el resto usa `fa-light` + `icon-medium`, excepto `fa-circle-user` que usa `fa-solid` + `icon-medium-solid`.",
      },
    },
  },
  render: () => `

/**
 * Headers — DS-MARS v2
 * Icon rule: fak fa-kit fa-wallet2 for wallet icon · fa-light for remaining header icons · fa-solid only for fa-circle-user (not-logged)
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Headers del app OKY. " +
          "**Regla de íconos:** `fak fa-kit fa-wallet2` para wallet · `fa-light` para el resto de íconos de header · " +
    ...
    const leftGroup = isDualLeft
      ...
      <div class="header-left-group header-side-cluster">
        <div class="header-icon">
          <i class="fak fa-kit fa-wallet2 icon-medium"></i>
        </div>
        <div class="header-icon">
...
export const AllHeaders = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: "Referencia visual de las variantes de header. Wallet usa `fak fa-kit fa-wallet2` + `icon-medium`; el resto usa `fa-light` + `icon-medium`, excepto `fa-circle-user` que usa `fa-solid` + `icon-medium-solid`.",
      },
    },
  },
  render: () => `
        ...
        <div>
          ...
          <div class="mars-mobile">
            <div class="app-header">
              <div class="header-left-group">
                <div class="header-icon"><i class="fak fa-kit fa-wallet2 icon-medium"></i></div>
              </div>

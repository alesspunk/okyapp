...
const TOUR_STEPS = [
  ...
  /* La última señala la promo con reloj: es el empujón que cierra el
     recorrido y da pie a la salida. */
  { target: ".oky-flow-home .tactic-strip", label: "¡Aprovecha que se acaban!" },
];

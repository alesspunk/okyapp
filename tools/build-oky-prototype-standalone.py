...
# vive en node_modules, que aquí no existe, así que los SVG que usa el
# prototipo están hechos vendor en images/flagpack/4x3/ — eso hace que
# resuelvan igual en Storybook (images/ se sirve en la raíz) y que aquí
# se puedan inlinear. Se toma la carpeta entera, así que una bandera
# nueva entra sola.
FLAGPACK = {
    os.path.splitext(name)[0]: "flagpack/4x3/" + name
    for name in sorted(os.listdir(os.path.join(IMAGES, "flagpack", "4x3")))

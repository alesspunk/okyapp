...
server.tool(
  "get_figma_file",
  "Get the top-level structure and metadata of a Figma file",
  {
    file: z
      .string()
...
server.tool(
  ...
  "Get specific nodes from a Figma file by their node IDs",
  {
    ...
    node_ids: z
      .array(z.string())
      .describe(
        "Array of node IDs to fetch (e.g. ['72353-22501', '72353-22502']). Node IDs can be found in the Figma URL after 'node-id='"
      ),
    depth: z
      .number()
      .int()
...
server.tool(
  ...
  "List all published components in a Figma file, including their names, descriptions, and IDs",
  {
    file: z
      .string()
      .describe("Figma file key or full Figma URL"),
...
server.tool(
  "get_figma_component_sets",
  "List all component sets (variants) in a Figma file",
  {
    file: z
      .string()
      .describe("Figma file key or full Figma URL"),
...
server.tool(
  "get_figma_styles",
  "Get all styles (colors, text, effects, grids) defined in a Figma file",
  {
    file: z
      .string()
      .describe("Figma file key or full Figma URL"),
...
server.tool(
  "export_figma_nodes",
  "Export one or more Figma nodes as image URLs (PNG, SVG, JPG, or PDF)",
  {
    file: z
      .string()
      .describe("Figma file key or full Figma URL"),
